...
public class GrpMediaPreviewActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = GrpMediaPreviewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = GrpMediaPreviewActivity.this;
        bindView();
        btnListener();
    ...
    private void InsertMessageWithFile(MediaFile media) {
        try {
            ...
            File path = new File(RealPathUtil.getRealPath(GrpMediaPreviewActivity.this, uriData));
    ...
    private void sendNotification(final ChatModel chatModel, MediaFile media) {
       ...
       // databaseReference.child("Chats").push().setValue(hashMap);
        ...
        count = count + 1;
        saveFilesToSd(mediatype, chatModel.getMessagess(), GrpMediaPreviewActivity.this, media);
    ...
    private void saveFilesToSd(int mediatype, String message, GrpMediaPreviewActivity trainerChatActivity, MediaFile media) {
        String path = "" ;
