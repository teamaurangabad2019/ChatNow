...
public class GrpVideoPreviewActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = GrpVideoPreviewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = GrpVideoPreviewActivity.this;
        bindView();
        btnListener();
        ...
        if (bundle != null) {
            ...
            Log.e(TAG, "onCreate: offchat " + myGroupId);
    ...
    private void sendNotification(final ChatModel chatModel, MediaFile media) {
       ...
       /* DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference();
        ...
        hashMap.put("receiverid",myGroupId);
