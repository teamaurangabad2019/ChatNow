...
public class GrpCameraPreviewActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = GrpCameraPreviewActivity.class.getSimpleName();
  ...
  //  private FirebaseUserModel offchattingPartner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = GrpCameraPreviewActivity.this;
        bindView();
        btnListener();
    ...
    private void sendNotification(final ChatModel chatModel) {
        ...
        count = count + 1;
        saveFilesToSd(mediatype, chatModel.getMessagess(), GrpCameraPreviewActivity.this);
    ...
    private void saveFilesToSd(int mediatype, String message, GrpCameraPreviewActivity trainerChatActivity) {
