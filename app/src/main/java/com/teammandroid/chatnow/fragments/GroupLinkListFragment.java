...
import com.teammandroid.chatnow.adapters.GroupLinkListRecyclerAdapter;
...
public class GroupLinkListFragment extends Fragment {


    private static final String TAG = GroupLinkListFragment.class.getSimpleName() ;
    ...
    private GroupLinkListRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_group_link_list, container, false);
    ...
    private void BindAnnoucements(final ArrayList<FirebaseGroupChatModel> arraylist) {
        try {
            ...
            rv_links.setLayoutManager(new LinearLayoutManager(activity));
            rv_links.setItemAnimator(new DefaultItemAnimator());
            rv_links.setHasFixedSize(true);
            rv_links.addItemDecoration(new DividerItemDecoration(activity,
                    DividerItemDecoration.VERTICAL));

            dialog.dismiss();


            adapter = new GroupLinkListRecyclerAdapter(getContext(), arraylist);
