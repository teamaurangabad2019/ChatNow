...
public class GroupMediaListFragment extends Fragment {
    ...
    private GroupMediaListRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_group_media_list, container, false);
    ...
    private void BindAnnoucements(final ArrayList<FirebaseGroupChatModel> arraylist) {
        try {
            ...
            dialog.dismiss();
            adapter = new GroupMediaListRecyclerAdapter(context, arraylist, new GroupMediaListRecyclerAdapter.ItemClickListener() {
                @Override
                public void onClick(View v, int position) {
                    ...
                    Utility.launchActivity(activity, GrpDetailsChattingActivity.class, false, bundle);
                }
            });
