...
import com.teammandroid.chatnow.activities.preview_activity.VideoPreviewActivity;
...
public class BottomSheetFileOptionsFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public static final String TAG = BottomSheetFileOptionsFragment.class.getSimpleName();
    ...
    public BottomSheetFileOptionsFragment() {
        // return;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        offchattingPartner = getArguments().getParcelable("offchattingPartner");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            if (requestCode == OPEN_IMAGE_PICKER) {
                ...
                bundle.putParcelable("offchattingPartner", offchattingPartner);
                bundle.putParcelableArrayList("files", files);
                bundle.putInt("mediaType", 1);
                Utility.launchActivityForResult(activity, MediaPreviewActivity.class, bundle, 2);
                ...
                Utility.launchActivityForResult(activity, VideoPreviewActivity.class, bundle, 2);
                ...
                Utility.launchActivityForResult(activity, AudioPreviewListActivity.class, bundle, 2);
