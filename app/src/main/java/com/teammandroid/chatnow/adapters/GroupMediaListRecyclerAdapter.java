...
public class GroupMediaListRecyclerAdapter extends RecyclerView.Adapter<GroupMediaListRecyclerAdapter.MyViewHolder> {
    ...
    private GroupMediaListRecyclerAdapter.ItemClickListener itemClickListener;

    public GroupMediaListRecyclerAdapter(Activity context, ArrayList<FirebaseGroupChatModel> list, GroupMediaListRecyclerAdapter.ItemClickListener itemClickListener) {
